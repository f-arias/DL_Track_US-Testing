...
**NOTA: El módulo *DL_Track_US/processing_manual_method.py* para procesar las imágenes de referencia del método manual se explica en [Descripcionn](./Explicacion_processing_manual_method.md).**
