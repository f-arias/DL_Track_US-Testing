...
**NOTA: Los modulos contenidos en *DL_Track_US/lib_ultrasound_utils* entre tantas funciones utiles, esta para procesar las imágenes de referencia del método manual se explica en [Descripcion](DL_Track_US/lib_ultrasound_utils/README.md).**
